...
var ReactSelectMaterialUi = (function (_super) {
    ...
    function ReactSelectMaterialUi(props) {
        ...
        _this.getFinalValue = function (value, values, defaultValue, defaultValues) {
        ...
        var defaultValue = props.defaultValue, defaultValues = props.defaultValues, value = props.value, values = props.values;
        var finalValue = _this.getFinalValue(value, values, defaultValue, defaultValues);
        _this.state = {
            filter: '',
            hasInputFocus: false,
    ...
    ReactSelectMaterialUi.prototype.render = function () {
        ...
        if (value === null || values === null) {
            ...
            var finalValue = this.getFinalValue(value, values);
            dropdownOption = this.getSelectedOption(options, finalValue);
        }
        var isClearable = !!SelectProps && SelectProps.isClearable === true && this.isClearable(dropdownOption);
